...
public class RSA {  
    ...
    public static String encrypt(String data) throws Exception {
    	RSAPublicKey pr = loadPublicKeyByStr(getPublicKey());
    	return new String(encrypt(pr, data.getBytes()));
    }
    /**
     * 随机密码解密
     * @param data         
    ...
    public static String decode(String data) throws Exception {
    	RSAPrivateKey pr = loadPrivateKeyByStr(getPrivateKey());
    	return new String(decrypt(pr, Base64.decode(data)));
    }
}  